...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('admin.jenis_anggaran.create') }}" class="btn btn-md btn-primary add-data"><i
                        ...
                        <tbody>
                            ...
                            @foreach ($jenis_anggaran as $item)
                                <tr class="tahun-anggaran-row">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-warning btn-md btn-edit"
                                            data-uuid="{{ $item->uuid }}" data-na="{{ $item->nomor_anggaran }}"
                                            data-nma="{{ $item->nama_anggaran }}" data-kda="{{ $item->kode_anggaran }}"
                                            data-sba="{{ $item->sumber_anggaran }}"
                                            data-ja="{{ $item->jenis_akun }}">Edit</button>
                                        <button type="button" class="btn btn-danger btn-md btn-hapus"
                                            data-uuid="{{ $item->uuid }}">Hapus</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
