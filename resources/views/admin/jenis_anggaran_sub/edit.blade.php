                        ...
                        <div class="row ">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-6">
                                        <input name="nama_sub_anggaran" value="{{$sub_anggaran->nama_sub_anggaran}}" type="text" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-2">Satuan Anggaran</label>
                                    <div class="col-6">
                                        <input name="satuan_anggaran" value="{{$sub_anggaran->satuan_anggaran}}" type="text" class="form-control" required>
                                    </div>
                                </div>
                            ...
                            @if ($jenis_anggaran->kode_anggaran == 'b001')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-6">
                                            <input name="harga_min" value="{{$sub_anggaran->harga_min}}" type="text" class="form-control" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-6">
                                            <input name="harga_max" value="{{$sub_anggaran->harga_max}}" type="text" class="form-control" required>
                                        </div>
                                    </div>
                            ...
                            @elseif ($jenis_anggaran->kode_anggaran == 'b002')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-6">
                                            <input name="luasan" value="{{$sub_anggaran->luasan}}" type="text" class="form-control" required>
                                        </div>
                                    </div>
